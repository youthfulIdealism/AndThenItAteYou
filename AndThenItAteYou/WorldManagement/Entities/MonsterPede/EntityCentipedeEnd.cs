...
{
    public class EntityCentipedeEnd : Entity
    {
        ...
        public EntityCentipedeEnd(Vector2 location, WorldBase world, Entity parent) : base(location, world)
        {
            this.width = 30;
            this.height = 30;
            currentTex = 0;
            tex = Game1.texture_monsterpede_butt[0];
            health = 150;
            this.walkSpeed = .2f;
            this.parent = parent;
        ...
        public override void prePhysicsUpdate(GameTime time)
        {
            ...
            {
                texSwapCounter = 0;
                currentTex = (currentTex + 1) % Game1.texture_monsterpede_butt.Length;
                tex = Game1.texture_monsterpede_butt[currentTex];
            }
